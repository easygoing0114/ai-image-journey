...
if (document.querySelector('.chartjs') !== null) {
  ...
  Defer.js('https://files.ai-image-journey.com/js/chartjs-adapter-date-fns.bundle.min.js', 'chartjsadapterdatefns', 200);
  Defer.js('https://files.ai-image-journey.com/js/chartjs_arrow_plugin.js', 'chartjsarrowplugin', 200);
  Defer.js('https://files.ai-image-journey.com/js/papaprase.js', 'papapease', 200);
  Defer.js('https://files.ai-image-journey.com/js/chartjs-run.js', 'chartjs-run', 300);
}
